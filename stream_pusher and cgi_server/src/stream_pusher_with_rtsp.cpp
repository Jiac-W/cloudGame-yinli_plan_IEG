...
{  	
	...
	// const char *filename = "rtmp://localhost:1935/live/home";
	// const char *filename = "rtmp://localhost:1935/rtmp_live/wjc";
	// const char *filename = "flv_output.mp4";		
	
	// for rtmp
	// const char *filename = "rtmp://121.5.5.221:1935/rtmp_live/wjc";

	// for rtsp
	const char *filename = "rtsp://121.5.5.221:8554/wjc";
